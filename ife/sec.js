require.config({
        ...
        require(
            [
             ...
             function (ec) {
                  var twochart = ec.init(document.getElementById('two'),'macarons');
                ...
                var all = document.getElementById('second').getElementsByTagName('li');   
                ...
                var mychart = ['line','bar','pie'];
                    ...
                    all[0].onclick = function () {
                        ...
                        twochart.setOption(option,notMerge=true);
                        myform[0] = mycity[0];
...
require.config({
        ...
        require(
            [
             ...
             function (ec) {
                  var thchart = ec.init(document.getElementById('three'),'macarons');
                ...
                thchart.setOption(option);

                var all = document.getElementById('third').getElementsByTagName('li');   
                var myform = [bjbj,'bar',7,0];
                var mycity = [bjbj,shsh,gzgz];
                var mychart = ['line','bar','pie'];
                    ...
                    all[0].onclick = function () {
                        ...
                        if( sm== 2) { option.series[0].data = setValue.low(dd,sj)};
                        option.series[0].itemStyle.normal.color = '#37C9CB';
                        thchart.setOption(option,notMerge=true);
                        myform[0] = mycity[0];
                        all[0].style.borderBottom="3px solid green";                        
                        all[1].style.borderBottom="0px";                        
                        all[2].style.borderBottom="0px";                        
...
require(
            [
             ...
             function (ec) {
                  var fochart = ec.init(document.getElementById('four'),'macarons');
                ...
                fochart.setOption(option);

                var all = document.getElementById('fouth').getElementsByTagName('li');   
                var myform = [bjbj,'bar',7,0];
                var mycity = [bjbj,shsh,gzgz];
                var mychart = ['line','bar','pie'];
                    ...
                    all[0].onclick = function () {
                        ...
                        if( sm== 2) { option.series[0].data = setValue.low(dd,sj)};
                        option.series[0].itemStyle.normal.color = '#37C9CB';
                        fochart.setOption(option,notMerge=true);
                        myform[0] = mycity[0];
                        all[0].style.borderBottom="3px solid green";                        
                        all[1].style.borderBottom="0px";                        
                        all[2].style.borderBottom="0px";                        
